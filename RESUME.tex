...
\newcommand{\projectentry}[5]{%
    \noindent\vspace{5pt}
    \textcolor{myblue}{\textbf{\href{#2}{#1}}} \textcolor{mydarkblue}{\href{#3}{\faLink}} % Link right next to project name
    \hfill {\small\textbf{\textcolor{mylightpurple}{#5}}} \\ \vspace{-10pt} % Technologies aligned to the right
